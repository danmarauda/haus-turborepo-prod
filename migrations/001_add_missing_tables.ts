/**
 * Migration 001: Add Missing Tables from Source Repository
 * 
 * This migration adds the 9 critical tables that exist in the source
 * repository but are missing from the target Turborepo.
 * 
 * Tables to create:
 * 1. dudReports - Trust/DUD database
 * 2. providers - Marketplace service providers
 * 3. compassListings - Map-based property search
 * 4. marketCategories - Service categories
 * 5. userProgress - Gamification XP/progress
 * 6. achievements - Achievement definitions
 * 7. lessons - Academy content
 * 8. tenders - Document management
 * 9. tenderDocuments - Tender document storage
 * 
 * Instructions:
 * 1. Copy table definitions into packages/backend/convex/schema.ts
 * 2. Run: cd packages/backend && bun run dev
...
// ============================================================================
// TABLE 1: DUD Reports (Trust/Safety Database)
// ============================================================================
...
// ============================================================================
// TABLE 2: Providers (Marketplace Service Providers)
// ============================================================================
...
// ============================================================================
// TABLE 3: Compass Listings (Map-based Property Search)
// ============================================================================
...
// ============================================================================
// TABLE 5: User Progress (Gamification)
// ============================================================================
...
// ============================================================================
// TABLE 7: Lessons (Academy Content)
// ============================================================================
...
// ============================================================================
// TABLE 8: Tenders (Document Management)
// ============================================================================
